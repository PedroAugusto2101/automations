...
<p><strong>Important to note! The pywin32 library is designed for Windows, so it won't function properly if you're using, for instance, Google Colab, as it's an IDE based on Linux.</strong></p>
